...
import 'package:toko/views/tambah_view.dart';
import 'package:toko/views/update_view.dart';
...
class HomeHeader extends StatelessWidget {
  const HomeHeader({Key? key, required this.onFetch}) : super(key: key);
          ...
          IconButton(
              onPressed: () {
                Navigator.push(context,
                        MaterialPageRoute(builder: (context) => TambahView()))
                    .then((_) => onFetch());
              },
              icon: Icon(Icons.add))
        ],
      ...
      children: [
        ...
        Padding(
          ...
          child: GridView.builder(
            ...
            itemCount: vm.barangList.length,
                  ...
                  Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => UpdateView(
                                  barangId: vm.barangList[index].id)))
                      .then((_) => vm.fetchBarang());
                },
                onDelete: () {
                  AwesomeDialog(
                          context: context,
                          ...
                          btnOkOnPress: () async {
                            await vm.deleteBarang(vm.barangList[index].id);
                            vm.fetchBarang();
                          },
            ...
            AspectRatio(
              ...
              child: Container(
                ...
                child: CachedNetworkImage(
                  imageUrl:
                      "http://10.0.2.2:8081/storage/images/${barang.gambarList[0].namaGambar}",
                  fit: BoxFit.cover,
