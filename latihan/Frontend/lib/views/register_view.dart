                  ...
                  SignUpForm(
                    ...
                    register: () async{
                      if(nameController.text.isNotEmpty && emailController.text.isNotEmpty && passwordController.text.isNotEmpty){
                        final response = await vm.register(nameController.text, emailController.text, passwordController.text);
                        AwesomeDialog(
                          context: context,
                          ...
                          btnOkOnPress: (){
                            if(response){
                              Navigator.pushAndRemoveUntil(
                                context, MaterialPageRoute(builder: (context) => ChatView()), (route) => false);
                            }
                          },
...
class SignUpForm extends StatelessWidget {
  const SignUpForm({required this.name, required this.email, required this.password, required this.register});
